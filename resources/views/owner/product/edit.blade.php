        ...
        <div class="card border-0 p-4 p-md-5">
            <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
                <div class="d-flex align-items-center gap-2.5">
                    ...
                    <div>
                        <h5 class="fw-extrabold text-dark mb-0">Edit Menu: {{ $product->name }}</h5>
                        <small class="text-muted">Perbarui harga porsi, stok hidangan, atau deskripsi menu</small>
                    </div>
                </div>
            ...
            <form action="{{ route('owner.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        ...
                        @if($product->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $product->image) }}" class="rounded-3 border" style="width: 72px; height: 72px; object-fit: cover;">
                            </div>
                        @endif
                    ...
                    <div class="col-md-4 d-flex align-items-center pt-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="is_available" value="1" class="form-check-input" id="isAvail" role="switch" @checked(old('is_available', $product->is_available))>
